...
describe('Kitchen Sink', () => {
  ...
  context('Location', () => {
    ...
    it('cy.location() - get window.location', () => {
      ...
      cy.location().should((location) => {
        expect(location.hash).to.be.empty.after(500);
        ...
        expect(location.search).to.be.empty.after(500);
      });
    });
  ...
  context('Navigation', () => {
    ...
    it('cy.visit() - visit a remote url', () => {
      ...
      cy.visit('https://example.cypress.io/commands/navigation', {
        ...
        onBeforeLoad(contentWindow) { // eslint-disable-line no-unused-vars
          // contentWindow is the remote page's window object
        },
        onLoad(contentWindow) { // eslint-disable-line no-unused-vars
          // contentWindow is the remote page's window object
        },
      });
    });
  ...
  context('Assertions', () => {
    ...
    describe('Explicit Assertions', () => {
      ...
      it('expect - make an assertion about a specified subject', () => {
        ...
        expect(true).to.be.true.after(500);
  ...
  context('Network Requests', () => {
    ...
    it('cy.server() - control behavior of network requests and responses', () => {
      ...
      cy.server().should((server) => {
        ...
        expect(server.headers).to.be.null.after(500);
        expect(server.response).to.be.null.after(500);
        expect(server.onRequest).to.be.undefined.after(500);
        expect(server.onResponse).to.be.undefined.after(500);
        expect(server.onAbort).to.be.undefined.after(500);

        // These options control the server behavior
        // affecting all requests

        // pass false to disable existing route stubs
        expect(server.enable).to.be.true.after(500);
        // forces requests that don't match your routes to 404
        expect(server.force404).to.be.false.after(500);
  ...
  context('Files', () => {
    ...
    it('cy.writeFile() - write to a file', () => {
      ...
      cy.fixture('users').should((users) => {
        expect(users[0].name).to.exist.after(500);
      });
  ...
  context('Local Storage', () => {
    ...
    it('cy.clearLocalStorage() - clear all data in local storage', () => {
      ...
      cy.clearLocalStorage().should((ls) => {
        expect(ls.getItem('prop1')).to.be.null.after(500);
        expect(ls.getItem('prop2')).to.be.null.after(500);
        expect(ls.getItem('prop3')).to.be.null.after(500);
      });
  ...
  context('Spies, Stubs, and Clock', () => {
    it('cy.spy() - wrap a method in a spy', () => {
      ...
      expect(spy).to.be.called.after(500);
    });
    ...
    it('cy.stub() - create a stub and/or replace a function with a stub', () => {
      ...
      expect(stub).to.be.called.after(500);
    });
  ...
  context('Utilities', () => {
    ...
    it('Cypress.moment() - format or parse dates using a moment method', () => {
      ...
      const time = Cypress // eslint-disable-line no-unused-vars
        .moment()
    ...
    it('new Cypress.Promise(function) - instantiate a bluebird promise', () => {
      ...
      function waitOneSecond() {
        ...
        return new Cypress.Promise(((resolve, reject) => { // eslint-disable-line no-unused-vars
          setTimeout(() => {
            // set waited to true
            waited = true;
  ...
  context('Cypress.dom', () => {
    ...
    it('Cypress.dom.isHidden() - determine if a DOM element is hidden', () => {
      ...
      expect(Cypress.dom.isHidden(hiddenP)).to.be.true.after(500);
      expect(Cypress.dom.isHidden(visibleP)).to.be.false.after(500);
    });
  });
  ...
  context('Cypress.Server', () => {
    ...
    it('Cypress.Server.defaults() - change default config of server', () => {
      Cypress.Server.defaults({
        delay: 0,
        force404: false,
        whitelist(xhr) { // eslint-disable-line no-unused-vars
